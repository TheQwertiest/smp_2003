_.mixin({
	listenbrainz : function (x, y, size) {
		...
		this.update_button = () => {
			buttons.buttons.listenbrainz = new _.button(this.x, this.y, this.size, this.size, {normal : this.properties.listenbrainz.enabled && _.isUUID(this.token) ? 'misc\\listenbrainz_active.png' : 'misc\\listenbrainz_inactive.png'}, () => { this.options(); }, 'Listenbrainz Options');
